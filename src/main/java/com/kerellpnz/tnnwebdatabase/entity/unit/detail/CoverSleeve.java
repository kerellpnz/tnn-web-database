...
@Entity
@Table(name = "coversleeves")
public class CoverSleeve extends BaseUnitWithZk {
    ...
    @JsonIgnore
    private List<CoverSleeveJournal> entityJournals;

    @OneToOne(mappedBy="coverSleeve",
    ...
    public CoverSleeve() {
        this.setName("Втулка центральная");
        this.setMaterial("09Г2С");
        this.setCertificate("-");
    }

    public CoverSleeve(CoverSleeve unit, String number) {
        super(unit, number);
    ...
    public List<CoverSleeveJournal> getEntityJournals() {
        return entityJournals;
    }

    public void setEntityJournals(List<CoverSleeveJournal> entityJournals) {
