...
<div class="contentTN">
    <div class="containerTN">
        <form:form id="saddleForm" class="form-horizontal" modelAttribute="entity" autocomplete="off"
                   action="${contextRoot}/entity/${assemblyDetail}/action"
                   method="POST">
            <div class="wrapper">
                <div class="characteristics">
                    ...
                    <div class="characteristics__row">
                        ...
                        <div class="characteristics__body">
                            <table class="table">
                                <tbody>
                                <c:if test="${assemblyDetail == 'Nozzles'}">
                                    <tr>
                                        <td class="label-column"><label class="control-label col-md-4 text-nowrap" for="tensileStrength">К К/Т:</label></td>
                                        <td style="min-width: 150px">
                                            <form:input path="tensileStrength" id="tensileStrength" class="form-control" tabindex="7" type="text" list="tensileStrengths"/>
                                    ...
                                    <tr>
                                        <td class="label-column"><label class="control-label col-md-4 text-nowrap" for="grooving">Разделка К/Т:</label></td>
                                        <td style="min-width: 150px">
                                            <form:input path="grooving" id="grooving" class="form-control" tabindex="7" type="text" list="groovings"/>
                                            <c:if test = "${not empty groovings}">
                                                <datalist id="groovings">
                                                    <c:forEach var="index" items="${groovings}">
                                                        <option value="${index}"/>
                                                    </c:forEach>
                                                </datalist>
                                            </c:if>
                                            <form:errors path="grooving" cssClass="help-block" element="em"/>
                                        </td>
                                    </tr>
                                </c:if>
                                <tr>
                ...
                <div class="equipment">
                    <div class="equipment-row">
                        ...
                        <c:if test="${assemblyDetail == 'Saddles'}">
                            <table style="width: 58%">
                                <tr>
                                    <td>
                                        <div class="equipment-row__body">
                                            <div class="tcp-row__label"><label class="control-label text-nowrap" for="tempSealId">Уплотнения:</label></div>
                                            <form:select path="tempSealId" id="tempSealId" class="form-control selectize" placeholder="Поиск уплотнений...">
                                        ...
                                        <div style="padding-left: 20px; padding-right: 20px">
                                            <table class="table table-striped table-bordered">
                                                <c:forEach var="tempObject" items="${entity.frontalSaddleSeals}" varStatus="s">
                                                    <c:url var="openLink" value="/entity/Saddles/openSeal">
                ...
                <div class="content-edit-page">
                    <div class="tab-control">
                        <ul class="nav nav-tabs" id="operations">
                            <li class="active">
                                <a href="#inputControl">Входной контроль</a>
                            </li>
                            <li>
                                <a href="#mechanical">Изготовление</a>
                            </li>
                        </ul>
                ...
                <div class="bottom-bar">
                    <div class="bottom-bar__row">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <button class="bottom-bar__button back-button" onclick="window.location.href='${contextRoot}/entity/${assemblyDetail}/showAll'; return false;">Назад</button>
                            </c:otherwise>
                        </c:choose>
